<template>
  <div>
    <div id="header" class="bg-[url('/bg-hero-5.jpg')] md:px-10 py-5 px-5">
      <div id="menu" class="grid md:grid-cols-2">
        <div id="menu-left">
          <h1 class="font-lilita md:text-6xl text-2xl text-white">FieldSpot</h1>
          </div>

        <div id="menu-right">
          <ul class="grid md:grid-cols-5 text-2xl font-oswald text-white pt-5  menu-right-mobile">
            <li>Home</li>
            <li>Features</li>
            <li>Solutions</li>
            <li>Pricing</li>
      ...
      <div class="grid md:grid-cols-2">
        <img src="front_mobile-removebg.png" class="md:absolute left-2 hidden md:block" alt="" />

        <div class="md:col-span-2 text-right font-bold my-10">
    ...
    <div id="section-1" class="grid md:grid-cols-2">
      <h1 class="text-6xl font-arial text-center py-20 px-24 pt-10 px-5">
        FieldSpot Mobile Applications
      </h1>
      <img src="workers-layout.png" class="md:pr-10 mx-auto mt-10" alt="" />
      <p
        class="font-roboto font-light text-grey-500 text-center text-lg md:px-24 -mt-20 pb-20"
      >
      ...
      <div class="grid md:grid-cols-2 px-40 gap-5 mx-auto">
        ...
        <div class="grid md:grid-cols-12 font oswald uppercase text-4xl text-yellow-800 px-40 gap-5">
        ...
        <div id="section-4" class="grid md:grid-cols-5 bg-orange-600 text-amber-200">
